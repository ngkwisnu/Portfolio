        ...
        <main className="container mx-auto">
            <div className="w-full flex py-20" id="about">
                ...
                <div className="ml-10 mr-20 my-auto py-10 w-3/5 text-slate-800">
                    ...
                    <h1 className="text-3xl font-semibold pb-3 leading-normal" data-aos="fade-left">Software Engineer Student at Bali State Polytechnic</h1>
                    <p className="font-medium text-slate-500 leading-normal pb-10" data-aos="fade-left">An active student enrolled in the D4 Software Engineering program at Bali State Polytechnic, currently in the sixth semester of the className of 2021. Possesses a diverse range of expertise in web development, including UX/UI design using Figma, front-end development (HTML, CSS, and JavaScript), as well as back-end development utilizing PHP, JavaScript, and frameworks like CodeIgniter and Laravel, Node.js, Express.js, and MySQL for database design. Additionally, proficient in soft skills such as Data Analysis, Research, and Project Management. Demonstrates a keen interest and talent in software design and development, particularly in the realm of website development.</p>
                    <div className="flex w-full" data-aos="fade-left">
                        <a href="https://drive.google.com/file/d/1qbYcoYcCSu8O6oeG8DUrf_bqjtmU4xe1/view?usp=sharing" target='blank' className="bg-blue-400 p-5 w-1/3 text-white font-semibold hover:bg-blue-700 transition mr-3">
                        ...
                        <p className="text-sm font-medium text-slate-500 my-auto">Follow me</p>
            ...
            <div className="w-full px-10 py-10 bg-gray-50 flex" id='service'>
                <div className="w-1/2 py-20">
                    <div className="mx-10 my-auto w-4/5 text-slate-800" data-aos="fade-right">
                        ...
                        <p className="font-medium text-slate-500 leading-normal pb-5">With my expertise and experience in web development, I am ready to help you grow your business through digital services. Immediately develop a digital business to expand your network and improve the quality of your business.</p>
                        <button className="bg-blue-400 p-5 w-2/5 text-white font-semibold hover:bg-blue-700 transition mr-3"><a href="#skills">NEXT <span className="pl-2"><i className="fa-solid fa-arrow-right"></i></span></a></button>
                        <hr className="w-20 my-auto mx-5" />
                    </div>
                </div>
                    ...
                    <div className="w-11/12" data-aos='fade-right'>
                        ...
                        <div className='flex mb-5'>
                            <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 flex my-auto">
                                <div className="bg-blue-600 h-1.5 rounded-full dark:bg-blue-500" style={{ width: '90%' }}></div>
                            </div>
                            <span className='ml-2 text-blue-600 my-auto font-semibold'>90%</span>
                        </div>
                        <div className="text-base font-medium">Back-End Developer</div>
                        <div className='flex mb-5'>
                            <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 flex my-auto">
                                <div className="bg-blue-600 h-1.5 rounded-full dark:bg-blue-500" style={{ width: '80%' }}></div>
                            </div>
                            <span className='ml-2 text-blue-600 my-auto font-semibold'>80%</span>
                        </div>
                        <div className="text-base font-medium">Front-End Developer</div>
                        <div className='flex mb-5'>
                            <div className="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700 flex my-auto">
                                <div className="bg-blue-600 h-1.5 rounded-full dark:bg-blue-500" style={{ width: '70%' }}></div>
                            </div>
                            <span className='ml-2 text-blue-600 my-auto font-semibold'>70%</span>
                        </div>
            ...
            <div className='bg-slate-50 flex py-16' id='contact'>
                <div className='w-2/5 my-auto ml-5'>
                    <div className="mx-10 my-auto text-slate-800">
                        <p className="font-bold text-blue-400 pb-1" data-aos="fade-right">CONTACT ME</p>
                        <h1 className="text-3xl font-semibold pb-1 leading-normal" data-aos="fade-right">Fill the form to <span className='text-blue-400'>get solution!</span></h1>
                        <p className="font-medium text-slate-500 leading-normal pb-5" data-aos="fade-right">When you contact me. I will be happy to serve you and provide the best service.</p>
                    </div>
                </div>
                <div className='w-1/2 m-10 pb-10 bg-white drop-shadow-xl rounded-lg' data-aos="zoom-in">
                    <div className="flex w-full pt-6 justify-center my-6">
                        <a href="https://www.github.com/ngkwisnu" className="text-xl text-slate-400 mr-10"><i className="fa-brands fa-github"></i></a>
                        <a href="https://www.linkedin.com/in/wisnumahesa" className="text-xl text-slate-400 mr-10"><i className="fa-brands fa-linkedin"></i></a>
                    ...
                    <form className="max-w-md mx-auto w-full pb-10">
                        ...
                        <button className='w-full bg-blue-400 mt-10 h-11 text-white font-semibold rounded-sm hover:bg-blue-700 transition'>Submit</button>
                    </form>
                </div>
            </div>
