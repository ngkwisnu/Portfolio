            ...
            <div className="w-full flex py-20" id="about">
                ...
                <div className="ml-10 mr-20 my-auto py-10 w-3/5 text-slate-800">
                    ...
                    <div className="flex w-full" data-aos="fade-left">
                        <a href="https://drive.google.com/file/d/1dovEVWtJ65RjNjWWljebVAK0ZVsopwwo/view" target='blank' className="bg-blue-400 p-5 w-1/3 text-white font-semibold hover:bg-blue-700 transition mr-3">
