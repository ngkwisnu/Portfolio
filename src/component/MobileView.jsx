    ...
    return (
        <>
            <div className='container mx-auto'>
                <header className="pt-5 py-20" style={{ backgroundImage: "url('img/hero3.png')", backgroundSize: 'cover' }} id="home">
                    <nav className="container fixed z-20 w-full top-0 m-auto font-chivo backdrop-blur-md bg-white/30">
                        <div className='w-full h-16 flex justify-around items-center'>
                            <a href='#home' className="flex items-center text-lg" data-aos='fade-down'>Wisnu Mahesa</a>
                            <i class="fa-solid fa-bars" onClick={() => setShow(!show)}></i>
                        </div>
                    </nav>
                    {show &&
                        <div className='bg-blue-500 backdrop-blur-sm mt-12'>
                            <ul className='flex flex-col justify-center items-center gap-3 py-5 text-white font-medium'>
                                <a href="#home">Home</a>
                    ...
                    <div className={`flex items-center justify-center w-full ${show ? `mt-0` : `mt-14`}`}>
                ...
                <main className="">
                    <div className="w-full flex flex-wrap justify-center items-center" id="about">
                    ...
                    <div className='bg-slate-50 flex-wrap py-16' id='contact'>
                        ...
                        <div className='w-4/5 mx-10 bg-white drop-shadow-xl rounded-lg' data-aos="zoom-in">
                    ...
                    <div className="h-96" style={{ backgroundImage: "url('img/Frame6.png')", backgroundSize: 'cover' }} >
                        <div className="w-full flex justify-center">
                            <div className="mx-10 my-auto w-4/5 text-slate-800 pt-52">
                                <p className="pt-4 font-bold text-xs font-poppins text-slate-400 pb-3 text-center" data-aos="fade-up">CONTACT ME</p>
                                <h1 className="text-xl font-semibold pb-3 leading-normal text-center text-white" data-aos="fade-up">Got a Project? Lets Talk!</h1>
